...
- CheckboxGroup/RadioGroup Compositional 전환 패턴 — L3
- ComboBox Compositional 전환 패턴 — L51
- Calendar Compositional 전환 패턴 — L186
- DatePicker Compositional 전환 패턴 — L201
- CSS 값 일관성 규칙 — L242
- DEFAULT_ELEMENT_HEIGHTS 주의사항 — L262
- Spec Shapes 배경색 규칙 (CRITICAL) — L277
- Breadcrumbs 컴포넌트 높이 계산 — L331
- Card 컴포넌트 높이 계산 — L353
- convertToFillStyle 기본 배경 투명 패턴 — L426
- TextSprite 렌더링 패턴 — L456
- Container Props 주입 패턴 (CONTAINER_PROPS_INJECTION) — L519
