...
export const SeparatorEditor = memo(function SeparatorEditor({
  elementId,
  currentProps,
  onUpdate,
}: PropertyEditorProps) {
      ...
      <PropertySection title="Design">
        <PropertySelect
          ...
          options={[
            {
              value: "default",
              label: PROPERTY_LABELS.SEPARATOR_VARIANT_DEFAULT,
            },
            {
              value: "dashed",
              label: PROPERTY_LABELS.SEPARATOR_VARIANT_DASHED,
            },
            {
              value: "dotted",
              label: PROPERTY_LABELS.SEPARATOR_VARIANT_DOTTED,
            },
          ]}
          icon={Layout}
        />
