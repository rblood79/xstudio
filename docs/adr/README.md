...
| [021](021-theme-system-redesign.md)               | 테마 시스템 개편 — Tint + Tailwind 인라인 패널 | Phase A+B+C 완료 (인라인 편집 + 3경로 동시 반영 + localStorage + Dark Mode Skia) | Phase D (레거시 정리), Phase E (컴포넌트별 accent 오버라이드)                                    |  **P2**  |
