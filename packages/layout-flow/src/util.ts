/**
 * Utility functions for @xstudio/layout-flow
 *
 * Forked from dropflow (chearon/dropflow) - Copyright 2024 Caleb Hearon, MIT License
 */

// Node.js process global (used for terminal-style detection in Logger)
declare const process: { stderr?: unknown } | undefined;
