 ...
 * PixiColorSlider
 *
 * 투명 히트 영역(pixiGraphics) 기반 ColorSlider
 ...
 * PixiColorSlider
 *
 * 투명 히트 영역 기반 ColorSlider (Skia 렌더링)
 ...
 */
export const PixiColorSlider = memo(function PixiColorSlider({
  element,
  //isSelected,
  onClick,
...
export default PixiColorSlider;
