...
- **2026-05-03 — post-cutover persistence / canonical frame scope fix**:
  ...
  - 검증: targeted builder vitest 11 files / 83 tests PASS, Layout Preset canonical mutation targeted vitest 8 files / 60 tests PASS, browser smoke 에서 page Button add/reload 유지 + frame Slot add/reload 유지 + immediate frame Layers `["body", "Slot: content"]` + unexpected console/page errors 0건, `pnpm run codex:preflight` PASS.
