...
> **최종 업데이트**: 2026-03-26 (ADR-041 배치 1/2/3 완료 + B/C 하이브리드 11개 진행 + 수동 editor 12개 제거)
...
| [041](041-spec-driven-property-editor.md)         | Spec-Driven Property Editor 자동 생성           | Phase 0~1 완료 + 배치 1/2/3 전환 완료 + 하이브리드 11개 진행 (`Button`, `SearchField`, `TextField`, `NumberField`, `Select`, `ComboBox`, `GridList`, `ListBox`, `TagGroup`, `Tabs`, `Tree`) + 수동 editor 12개 제거 | 나머지 등급 B/C 하이브리드 전환                                                                                                        |    P4    |
