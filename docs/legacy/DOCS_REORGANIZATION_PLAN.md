...
| `composition_FEATURES_DB_COMPATIBILITY.md`          | `reference/status/DB_COMPATIBILITY.md`      |
...
| `research/composition_REDESIGN_PLAN.md`                  | `explanation/research/REDESIGN_PLAN.md`             |
