...
import { File, SquarePlus, DatabaseZap, LibraryBig, Palette, WandSparkles, Users, Settings, ChevronLeft } from 'lucide-react';
...
export const SidebarNav: React.FC<SidebarNavProps> = ({ activeTabs, onTabChange, onCloseAll }) => {
