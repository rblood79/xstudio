...
> **Database Name**: `composition`

## Overview

composition는 브라우저의 IndexedDB를 사용하여 모든 프로젝트 데이터를 로컬에 저장합니다. 이 문서는 데이터베이스 스키마, 테이블 구조, 관계 및 버전 관리에 대해 설명합니다.
...
│                      IndexedDB Storage                           │
│  ┌────────────────────────────────────────────────────────────┐ │
│  │  Database: "composition" (Version 7)                           │ │
│  │  ┌──────────┐ ┌──────────┐ ┌──────────┐ ┌──────────┐      │ │
│  │  │ projects │ │  pages   │ │ elements │ │ layouts  │      │ │
│  │  └──────────┘ └──────────┘ └──────────┘ └──────────┘      │ │
│  │  ┌──────────┐ ┌──────────┐ ┌──────────┐ ┌──────────┐      │ │
...
```json
{
  ...
  "responseMapping": {
    "dataPath": "data.users",
    "fieldMappings": [{ "sourceKey": "full_name", "targetKey": "name" }]
  },
