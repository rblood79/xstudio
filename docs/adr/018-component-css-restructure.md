...
**React 컴포넌트 변경**: `className`에 `button-base` 추가 필요 (e.g. `<Button className="button-base">`)
...
### Phase 5: Tier 4 컴포넌트 전환 — 복합/오버레이류 (15+파일)

**목표**: 나머지 컴포넌트 정리 (Popover, Dialog, Menu, ListBox, Table, Tabs 등)
...
1. **React 컴포넌트 className 변경 필요** — `button-base`, `indicator`, `inset` 클래스 추가
