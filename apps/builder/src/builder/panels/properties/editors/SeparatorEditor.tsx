...
import { PropertySelect, PropertyCustomId, PropertyInput , PropertySection} from '../../../components';
import { PropertyEditorProps } from '../types/editorTypes';
import { PROPERTY_LABELS } from '../../../../utils/ui/labels';
import { useStore } from '../../../stores';

export const SeparatorEditor = memo(function SeparatorEditor({ elementId, currentProps, onUpdate }: PropertyEditorProps) {
