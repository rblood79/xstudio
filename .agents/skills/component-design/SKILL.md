...
```
Read .Codex/skills/react-aria/references/components/{ComponentName}.md
```
...
```
Read .Codex/skills/react-aria/references/guides/collections.md    → 컬렉션 패턴
Read .Codex/skills/react-aria/references/guides/selection.md      → 선택 패턴
Read .Codex/skills/react-aria/references/guides/forms.md          → 폼 패턴
Read .Codex/skills/react-aria/references/interactions/usePress.md → 인터랙션 훅
```

### 1-3. React Spectrum S2 참조 (디자인 시스템 비교 시)

```
Read .Codex/skills/react-spectrum/references/components/{ComponentName}.md
```
