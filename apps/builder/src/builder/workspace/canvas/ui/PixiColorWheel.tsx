...
export function PixiColorWheel({
  ...
  const sizePreset = useMemo(() => {
    const sizeSpec = ColorWheelSpec.sizes[size] || ColorWheelSpec.sizes[ColorWheelSpec.defaultSize];
    return getSpecSizePreset(sizeSpec, 'light');
  }, [size]);

  const variantColors = useMemo(() => {
    const variantSpec = ColorWheelSpec.variants[variant] || ColorWheelSpec.variants[ColorWheelSpec.defaultVariant];
