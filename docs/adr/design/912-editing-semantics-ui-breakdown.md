...
| Pages ↔ Frames 전환 시 화면 갱신이 바로 되지 않음 | Preview iframe pageInfo effect dependency 에 `editMode`/`currentLayoutId` 를 추가해 page/layout mode 전환 메시지를 즉시 전송 |
