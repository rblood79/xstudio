...
import { Tag, BarChart3, ToggleLeft, Layout, PencilRuler, ArrowDown, ArrowUp, Globe, DollarSign } from 'lucide-react';
...
export const ProgressBarEditor = memo(function ProgressBarEditor({ elementId, currentProps, onUpdate }: PropertyEditorProps) {
