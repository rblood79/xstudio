 ...
 * PixiColorWheel
 *
 * 투명 히트 영역(pixiGraphics) 기반 ColorWheel
 ...
 * PixiColorWheel
 *
 * 투명 히트 영역 기반 ColorWheel (Skia 렌더링)
 ...
 */
export const PixiColorWheel = memo(function PixiColorWheel({
  element,
  //isSelected,
  onClick,
}: PixiColorWheelProps) {
