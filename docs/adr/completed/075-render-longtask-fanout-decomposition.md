...
| ---- | ------------- | ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------ |
| G1   | P0 land 후    | prod baseline 측정 완료 + **구간별 observe 분해 확보** + `docs/design/075-prod-baseline.md` 기록 | N/A (측정 자체). 구간별 분해 미확보 시 **Phase 1 진입 금지** |
