import{r as a,j as i,P as u,J as c,al as m,am as x,an as f}from"./index-BYIeUA-_.js";import{E as y}from"./eye-off-DS1BjQPh.js";const h={desktop:{name:"desktop",minWidth:1280,maxWidth:void 0,label:"Desktop",icon:"Monitor"},tablet:{name:"tablet",minWidth:768,maxWidth:1279,label:"Tablet",icon:"Tablet"},mobile:{name:"mobile",minWidth:0,maxWidth:767,label:"Mobile",icon:"Smartphone"}},g=["desktop","tablet","mobile"];function k({breakpoint:n,size:e=16}){switch(n){case"desktop":return i.jsx(f,{size:e});case"tablet":return i.jsx(x,{size:e});case"mobile":return i.jsx(m,{size:e});default:return null}}const N=a.memo(function({visibility:e={},onChange:t,title:d="Responsive Visibility",disabled:l=!1}){const b=a.useCallback(s=>{const r=e[s]??!0;t({...e,[s]:!r})},[e,t]),v=a.useCallback(()=>{t({desktop:!0,tablet:!0,mobile:!0})},[t]),p=a.useCallback(()=>{t({desktop:!1,tablet:!1,mobile:!1})},[t]);return i.jsxs(u,{title:d,icon:c,children:[i.jsxs("div",{className:"responsive-visibility-editor",children:[i.jsx("div",{className:"responsive-visibility-buttons",children:g.map(s=>{const r=e[s]??!0,o=h[s];return i.jsxs("button",{type:"button",className:`responsive-visibility-btn ${r?"visible":"hidden"}`,onClick:()=>b(s),disabled:l,title:`${o.label}: ${r?"Visible":"Hidden"} (${o.minWidth}px${o.maxWidth?`-${o.maxWidth}px`:"+"})`,"aria-pressed":r,children:[i.jsx(k,{breakpoint:s,size:14}),i.jsx("span",{className:"responsive-visibility-label",children:o.label}),r?i.jsx(c,{size:12}):i.jsx(y,{size:12})]},s)})}),i.jsxs("div",{className:"responsive-visibility-actions",children:[i.jsx("button",{type:"button",className:"responsive-visibility-action",onClick:v,disabled:l,title:"Show on all breakpoints",children:"Show All"}),i.jsx("button",{type:"button",className:"responsive-visibility-action",onClick:p,disabled:l,title:"Hide on all breakpoints",children:"Hide All"})]}),i.jsx("p",{className:"responsive-visibility-help",children:"Control element visibility at different screen sizes"})]}),i.jsx("style",{children:`
      ...
      `})]})});export{N as ResponsiveVisibilityEditor,N as default};
