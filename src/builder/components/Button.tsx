...
const button = tv({
  ...
  variants: {
    variant: {
      ...
      surface: 'bg-white hover:bg-gray-50 pressed:bg-gray-100 text-gray-800 dark:bg-zinc-600 dark:hover:bg-zinc-500 dark:pressed:bg-zinc-400 dark:text-zinc-100',
