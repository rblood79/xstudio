...
> **최종 업데이트**: 2026-03-21 (ADR-043 Collapsed Compositional Rendering 추가)
...
| [043](043-collapsed-compositional-rendering.md) | Collapsed Compositional Rendering     | Proposed | Compositional 컴포넌트 단일 렌더링 최적화 — 6 Phase (Builder + Command Stream + Store + Layer) |  **P2**  |
