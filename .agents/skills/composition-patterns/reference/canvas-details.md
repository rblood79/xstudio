...
> 이 파일은 `.agents/rules/canvas-rendering.md`의 diet version에서 이동된 구현 세부사항입니다.
...
- 상세: [`../rules/spec-container-dimension-injection.md`](../rules/spec-container-dimension-injection.md)
