...
| Phase 3 완료 | Phase 2 후 | showValue→valueLabel 타입 변경. 6개+ 참조 경로 (shapes/renderer/shared/implicitStyles) 동작 | Phase 2까지만 유지                      |
...
- Phase 3 valueLabel은 빌더에서 ReactNode 직접 입력이 불가하여, boolean toggle + 커스텀 텍스트 옵션 등 프로퍼티 패널 UI 설계 필요
