...
> 구현 상세: [087-implicitstyles-residual-branches-categorized-sweep-breakdown.md](../../adr/design/087-implicitstyles-residual-branches-categorized-sweep-breakdown.md)
