...
import { Tag, PointerOff, Focus, SquareX, Menu } from "lucide-react";
import {
  PropertyInput,
  PropertySelect,
  PropertySwitch,
...
export const MenuEditor = memo(function MenuEditor({
  elementId,
  currentProps,
  onUpdate,
}: PropertyEditorProps) {
    ...
    <>
      ...
      <PropertySection title="State">
        ...
        <PropertyInput
          ...
          value={
            Array.isArray(currentProps.selectedKeys)
              ? currentProps.selectedKeys.join(", ")
              : ""
          }
          onChange={(value) => {
            const keys = value
        ...
        <PropertyInput
          ...
          value={
            Array.isArray(currentProps.defaultSelectedKeys)
              ? currentProps.defaultSelectedKeys.join(", ")
              : ""
          }
          onChange={(value) => {
            const keys = value
