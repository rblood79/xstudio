...
015-layout-engine.md에서 Strategy A(Taffy 단독)를 기각한 이유는 **"IFC(Inline Formatting Context) 갭이 너무 크다"**였다.
...
- [ENGINE.md](015-layout-engine.md) -- Taffy + Dropflow 레이아웃 엔진 전략
